...
- Описание и дисклеймер приведены к факту: ответ из официальной выгрузки ГРЛС
  и реестра предельных цен ЖНВЛП. Отзыв серий и текст инструкции этими
  архивами не закрываются. Выпуск на витрину Python не делался.
